...
subrinnards_name : function (n,rec,) {
enter_rule ("subrinnards_name");
    set_return (`${n.rwr ()}${rec.rwr ().join ('')}`);
return exit_rule ("subrinnards_name");
},
...
enter_rule ("subrinnards_other");
    set_return (`${c.rwr ().join ('')}${rec.rwr ().join ('')}`);
