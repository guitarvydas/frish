...
item_scope : function (s,) {
enter_rule ("item_scope");
    set_return (`${s.rwr ()}`);
return exit_rule ("item_scope");
},
...
Scope_functionblock : function (_func,name,lb,formals,rb,block,) {
enter_rule ("Scope_functionblock");
    set_return (`\nfunction ${name.rwr ()} (${formals.rwr ().join ('')}) ${block.rwr ()}`);
return exit_rule ("Scope_functionblock");
},
Scope_subrblock : function (_subr,name,block,) {
enter_rule ("Scope_subrblock");
    set_return (`\nsubr ${name.rwr ()} ${block.rwr ()}`);
return exit_rule ("Scope_subrblock");
},
Block : function (lb,innards,rb,) {
enter_rule ("Block");
    pushnewmacroscope ();
...
blockInnards_rec : function (lb,innards,rb,more,) {
enter_rule ("blockInnards_rec");
    set_return (`{${innards.rwr ()}}rb${more.rwr ().join ('')}`);
return exit_rule ("blockInnards_rec");
},
blockInnards_pattern : function (p,more,) {
enter_rule ("blockInnards_pattern");
    set_return (`${p.rwr ()}${more.rwr ().join ('')}`);
return exit_rule ("blockInnards_pattern");
},
blockInnards_other : function (cs,more,) {
enter_rule ("blockInnards_other");
    set_return (`${cs.rwr ().join ('')}${more.rwr ().join ('')}`);
return exit_rule ("blockInnards_other");
},
