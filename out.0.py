...
def pushasinteger (word):                              #line 96
...
def compileinteger (word):                             #line 104
...
def compilefloat (word):                               #line 109
...
def code (name,flags,does):                            #line 114
...
def doconst ():# method for const                      #line 145
...
def _find (name):                                      #line 168
    ...
    while ( x >=  0):                                  #line 171
        ...
        if ( name ==  State.RAM [ x+ 1]):# # Match!    #line 173
...
def debugok ():                                        #line 182
    ...
    while not (State.BUFP >= len(State.BUFF)) :        #line 186

        if ( xinterpret()):                            #line 187
...
def _walk ():
    match opcode:
        ...
        case "swap":                                   #line 341
                ...
                B = State.S.pop ()                     #line 343


                A = State.S.pop ()                     #line 344

                State.S.push ( B)                      #line 345

                State.S.push ( A)                      #line 346
        ...
        case "(loop)":                                 #line 492
                ...
                if ( cond):# clean up rstack if index >= limit #line 498
        ...
        case "dump":                                   #line 563
                ...
                while ( a <  start+( min( n, ( len( State.RAM) - start)))):#line 568
        ...
        def ; ():                                      #line 644
                ...
                State.compiling = False                #line 648
        ...
        case "interpret":                              #line 651
                ...
                if ( found):                           #line 664
                    ...
                    if (State.compiling):              #line 665

                        if ( foundimmediate):          #line 666
                    ...
                    if (State.compiling):              #line 677

                        if (re.match(r"^-?\d*$",  item)):#line 678
                            ...
                            if (re.match(r"^-?d*\.?\d*$",  item)):#line 681
                        ...
                        if (re.match(r"^-?\d*$",  item)):#line 690
                            ...
                            if (re.match(r"^-?d*\.?\d*$",  item)):#line 693
