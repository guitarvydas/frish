...
pretransmogrifier {
  ...
  subrinnard =
    | "{" subrinnard* "}" subrinnard?     -- rec
    | applySyntactic<Pattern> subrinnard? -- pattern
    | (~"}" any)+  subrinnard?            -- other
