...
splitter {
  ...
  initializeSection = noise "initialize" noise "{" noise "λ" ident noise "(" noise ")" noise "}" noise

  functionDefinition = noise "function" noise token noise formals noise statementBlock noise
